<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NewsCreate.aspx.cs" Inherits="Project_Shode.NewsCreate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Label ID="createProjectTittle" runat="server" Text="Edit news item" 
       ...
       <asp:Panel>
            ...
            <div class="clear"></div>
            <asp:Button ID="Button1" runat="server" Text="Send" CssClass="ButtonShode" OnClick="create_News"></asp:Button>
            <div class="clear"></div>
        </asp:Panel>
    </section>
</asp:Content>
