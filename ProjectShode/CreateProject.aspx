...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentProject" runat="server">
  ...
  <section class="formNewProject">
    <section class="boxesProject">
        ...
        <asp:TextBox ID="tittleProjectTextbox" runat="server" MaxLength=30 Width=400px CssClass=TextBoxLogSign
    ...
    <section class="boxesProject">
        <asp:TextBox ID="descriptionTextbox" runat="server" MaxLength=1500 TextMode="MultiLine" Font-Names="Segoe UI"
